...
import com.wahidabd.moviecleanarchitecture.utils.Constant.BASE_URL
import com.wahidabd.moviecleanarchitecture.utils.Constant.MOVIE_URL
...
class AppModule {
    ...
    @Provides
    fun provideApi(retrofit: Retrofit): ApiMovie =
